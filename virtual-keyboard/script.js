...
7. Не знал как сделать так чтобы клавиши можно было зажать и их не колбасило, т.е. при зажатии Shift реальной клавиатуры могут быть баги в виде того что Css кнопка не отжалась.
